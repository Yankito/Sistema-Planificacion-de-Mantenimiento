...
export const ControlGastosView = () => {
    ...
    return (
        <div className="space-y-2 animate-fade-in-up">
            {/* Header */}
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-4 rounded-3xl border border-pf-neutral-100 shadow-sm">
                <div>
                    <h1 className="text-2xl font-black text-pf-neutral-800 tracking-tight uppercase italic leading-none">Control de Gastos</h1>
                    <p className="text-[10px] font-black text-pf-neutral-400 uppercase tracking-[0.2em] mt-1 pl-0.5">Gestión y Visualización Presupuestaria</p>
                </div>
                <div className="flex items-center gap-3 bg-pf-neutral-50 p-1.5 rounded-xl border border-pf-neutral-100 shadow-inner">
                    <div className="flex flex-col min-w-[120px]">
                        <label className="text-[10px] font-black text-pf-neutral-400 uppercase mb-0.5 px-1 tracking-widest">Planta</label>
                        <select
                            value={selectedPlanta}
                            onChange={(e) => setSelectedPlanta(e.target.value)}
                            className="px-3 py-2 bg-white border border-pf-neutral-200 rounded-lg text-[12px] font-black text-pf-neutral-700 outline-none focus:border-pf-red/30 transition-all shadow-sm"
                        >
                    ...
                    <div className="flex flex-col min-w-[90px]">
                        <label className="text-[10px] font-black text-pf-neutral-400 uppercase mb-0.5 px-1 tracking-widest">Año</label>
                        <select
                            value={selectedYear}
                    ...
                    <div className="flex flex-col min-w-[140px]">
                        <label className="text-[10px] font-black text-pf-neutral-400 uppercase mb-0.5 px-1 tracking-widest">Periodo</label>
                        <select
                            ...
                            className={`px-3 py-2 bg-white border border-pf-neutral-200 rounded-lg text-[12px] font-black text-pf-neutral-700 outline-none focus:border-pf-red/30 transition-all shadow-sm ${activeTab === 'config' ? 'opacity-40 cursor-not-allowed bg-pf-neutral-100' : ''}`}
                        >
            ...
            <div className="border-b border-pf-neutral-200">
                <nav className="-mb-px flex space-x-8" aria-label="Tabs">
                    <button
                        ...
                        className={`
                            whitespace-nowrap py-3 px-1 border-b-[3px] font-black text-[10px] uppercase tracking-widest flex items-center gap-2 transition-all
                            ${activeTab === 'monitor'
                        ...
                        `}
                    >
                        <Activity size={16} className={activeTab === 'monitor' ? 'text-pf-red shadow-sm' : ''} />
                        Monitoreo
                    </button>
                    ...
                    <button
                        ...
                        `}
                    >
                        <PieChart size={16} className={activeTab === 'breakdown' ? 'text-pf-red shadow-sm' : ''} />
                        Análisis
                    </button>
                    ...
                    <button
                        ...
                        `}
                    >
                        <Settings size={16} className={activeTab === 'config' ? 'text-pf-red shadow-sm' : ''} />
                        Parámetros
                    </button>
                </nav>
            </div>
