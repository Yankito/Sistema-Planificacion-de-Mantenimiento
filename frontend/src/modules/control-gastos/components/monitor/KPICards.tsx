...
export const KPICards: React.FC<KPICardsProps> = ({
    ...
    return (
        <div className="space-y-6">
                            ...
                            <div className="mt-6 space-y-4">
                                ...
                                <div className="p-4 bg-pf-neutral-50 rounded-2xl border border-pf-neutral-100 shadow-inner">
                                    ...
                                    <div className="flex justify-between items-baseline">
                                        ...
                                        <div className="text-[10px] font-black text-pf-neutral-500 uppercase">Real: {formatCurrency(totalPlanReal)}</div>
                                    </div>
                                ...
                                <div className="p-4 bg-pf-warning-50/50 rounded-2xl border border-pf-warning-100/50">
                                    ...
                                    <div className="flex justify-between items-baseline">
                                        ...
                                        <div className="text-[10px] font-black text-pf-warning-500 uppercase">Real: {formatCurrency(totalCorrectivoReal)}</div>
                                    </div>
            ...
            <div className="bg-pf-neutral-50 p-8 rounded-[2.5rem] border border-pf-neutral-200/60 shadow-inner relative">
                <div className="flex items-center justify-between mb-8">
                    ...
                    <button
                        ...
                        className="p-3 hover:bg-white rounded-2xl transition-all text-pf-neutral-400 flex items-center gap-2 group shadow-sm bg-white/50 border border-pf-neutral-100"
                    >
                        <span className="text-[10px] font-black uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-opacity">
